class HashTable:
    ...
    def __getitem__(self, key):
        ...
        :worst time complexity: O(N+K) where N is the length of the hashtable and K is the
        length of the key
        :best time complexity: O(K) where K is the length of the key
    ...
    def __setitem__(self, key, item):
        ...
        :worst time complexity: O(N+K) where N is the length of the hashtable and K is the length
        of key
        :best time complexity: O(K) and K is the length of key
    ...
    def __contains__(self, key):
        ...
        :worst time complexity: O(N+K) where N is the size of the hashtable and K is the length of
        key
    ...
    def check_rehash(self):
        """
        Checks to see if the hashtable has enough elements within it to resize (must have more than half elements
        taken)

        :worst time complexity: O(1)
        :return: best time complexity O(1)
        """
...
class Freq:
    def __init__(self):
        ...
        object of Hash Table and max val containing the maximum frequency a word appeared.
        :worst time complexity: O(1)
        :best time complexity: O(1)
        """
